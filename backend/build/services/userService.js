      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            if (user) {
              check = _bcryptjs["default"].compareSync(password, user.password); // let check = password===user.password;
              if (check) {
                userData.errCode = 0;
...
var createNewUser = function createNewUser(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var check, hashPasswordFormBcrypt;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 10:
            hashPasswordFormBcrypt = _context5.sent;
            console.log(data);
            _context5.next = 14;
