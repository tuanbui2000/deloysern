...
var sendSimplemail = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          info = transporter.sendMail({
            from: '"Tún👻" <tuanbui1589@gmail.com>',
            // sender address
  ...
  return function sendSimplemail(_x) {
...
var sendAttatchment = /*#__PURE__*/function () {
                ...
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return transporter.sendMail({
                      ...
                      // html body
                      attachments: [{
                        filename: "remedy-".concat(dataSend.patientId, "-").concat(new Date().getDate(), ".png"),
  ...
  return function sendAttatchment(_x2) {
