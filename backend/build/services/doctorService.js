...
var checkRequiredFields = function checkRequiredFields(inputdata) {
  var arrFields = ["doctorId", "contentHTML", "contentMarkdown", "selectedPrice", "selectedPayment", "action", "selectedProvince", "nameClinic", "addressClinic", "note", "note", "specialtyId"];
  var isVailed = true;
  var element = '';
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            resolve({
              errCode: 1,
              errMessange: "missing required parameters: ".concat(checkObj.element)
            });
            _context3.next = 24;
            break;
          case 6:
...
var getDetailDoctorByIdService = function getDetailDoctorByIdService(userId) {
  // console.log(userId);
  return new Promise( /*#__PURE__*/function () {
...
var getExtraInfoDoctorByIdService = function getExtraInfoDoctorByIdService(doctorId) {
  return new Promise( /*#__PURE__*/function () {
...
var getProfileDoctorByIdService = function getProfileDoctorByIdService(doctorId) {
  return new Promise( /*#__PURE__*/function () {
...
var getListPatientService = function getListPatientService(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
    ...
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 12:
            _context10.next = 14;
            return _emailService["default"].sendAttatchment(data);
          case 14:
            resolve({
              errCode: 0,
              errMessange: "oke"
